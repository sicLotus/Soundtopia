...
public class ChartEntryVO {
	...
	public void setMovie_title(String movie_title) {
		...
		for (String del : delimiter) {
			...
			if (index >= 0) {
				...
				setTitle(movie_title.substring(index + del.length()).replaceAll("\\(.*\\)", "").replaceAll("Official HD.*", ""));
				break;
			} else {
				setInterpreter("");
	 ...
	 * 
	 * 
	 * public String getMovie_thumbnail() { return movie_thumbnail; }
	 * 
	...
	/*
	 * public int getMovie_owner_id() { return movie_owner_id; }
	 * 
	 * public void setMovie_owner_id(int movie_owner_id) { this.movie_owner_id =
	 * movie_owner_id; }
	 * 
	 * public String getMovie_owner() { return movie_owner; }
	 * 
	 * public void setMovie_owner(String movie_owner) { this.movie_owner =
	 * movie_owner; }
	 * 
	 * public String getMovie_owner_url() { return movie_owner_url; }
	 * 
	 * public void setMovie_owner_url(String movie_owner_url) {
	 * this.movie_owner_url = movie_owner_url; }
	 * 
	 * public double getMovie_rating() { return movie_rating; }
	 * 
	 * public void setMovie_rating(double movie_rating) { this.movie_rating =
	 * movie_rating; }
	 * 
	 * public int getMovie_views() { return movie_views; }
	 * 
	 * public void setMovie_views(int movie_views) { this.movie_views =
	 * movie_views; }
	 * 
	 * public int getMovie_added() { return movie_added; }
	 * 
	 * public void setMovie_added(int movie_added) { this.movie_added =
	 * movie_added; }
	 */
	...
	/*
	 * public String getPermathumblink() { return permathumblink; }
	 * 
